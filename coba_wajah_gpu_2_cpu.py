...
# Modify the fully connected layer to match the number of classes in your model (4 classes)
model.fc = nn.Linear(in_features=1024, out_features=4)  # 4 output classes (very low, low, high, very high)
